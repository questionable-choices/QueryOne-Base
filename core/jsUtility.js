...
Q.core.utilities = (function() {
  // Shorthand for commonly used functions & for ease of maintainence
  var scrollDown = function() { $('#output').scrollTop(document.getElementyById('output').scrollHeight) }
  var print      = Q.core.print
  var prompt     = Q.core.prompt
  var receive    = Q.core.receive
...
clone       = Q.core.utilities.clone
// dateSep     = Q.core.utilities.interval
display     = Q.core.utilities.display
echoCommand = Q.core.utilities.pecho
Qround      = Q.core.utilities.round2
uniqueArray = Q.core.utilities.uniqueA
